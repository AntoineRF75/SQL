...
SELECT * FROM logement WHERE prix < 150000 AND categorie = "vente"
ORDER BY prix ASC;
...
SELECT ville, COUNT(*) AS nombre FROM logement WHERE categorie ="vente"
GROUP BY ville;
...
SELECT prenom FROM personne WHERE idPersonne IN
(SELECT MIN(2) FROM(COUNT()  idPersonne from demande WHERE categorie = "vente"));
