...
SELECT id_abonne, prenom, date_sortie, date_rendu
FROM abonne
INNER JOIN emprunt ON abonne.id_abonne = emprunt.id_abonne -- prefix --
WHERE prenom = "Guillaume";
...
-- EXERCICE : Nous aimerions les dates de sortie et les dates de rendu pour les livres ecrit par alphonse daudet
