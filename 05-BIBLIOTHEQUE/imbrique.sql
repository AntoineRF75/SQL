...
SELECT COUNT(*) AS "nombre de livre" FROM emprunt WHERE id_abonne IN
...
-- SELECT id_abonne FROM abonne WHERE id_abonne IN
-- (SELECT COUNT(id_abonne) FROM emprunt IN
-- (SELECT MAX(id_abonne) AS "meilleur abo" FROM emprunt));